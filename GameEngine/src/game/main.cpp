...
int main()
{
	...
	std::shared_ptr<GUI> guiAdd = currentCamera->addComponent<GUI>();
	...
	catModel->getComponent<Transform>()->setLocalpos(glm::vec3(5, 0, 0));
	...
	yellowBox->getComponent<Transform>()->setLocalpos(glm::vec3(1, -2, 0));
	yellowBox->getComponent<Transform>()->setLocalrot(glm::vec3(0, 0, 0));
	yellowBox->getComponent<Transform>()->setLocalScale(glm::vec3(5.0f));
	...
	currentCamera->getComponent<Transform>()->setLocalrot(glm::vec3(-15, 0, 0) );
	...
	catModel->getComponent<BoxCollider>()->setOffset(glm::vec3(0.0f, 0.0f, 0.0f));
	...
	yellowBox->getComponent<BoxCollider>()->setVar(false);
	yellowBox->getComponent<BoxCollider>()->setSize(glm::vec3(2.0f));
	...
	currentCamera->getComponent<GUI>()->setMaterial(guiMat);
	currentCamera->getComponent<GUI>()->textureGUI(glm::vec4(10.0f, 10.0f, 100.0f, 100.0f));
